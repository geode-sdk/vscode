...
import { clamp, importCodiconToolkit, importWebviewToolkit } from "../utils/utils";
...
export abstract class Widget {
    ...
    private addHandlersToPanel() {
        ...
        if (this.#panel && this.#id) {
            for (let [id, hnd] of Object.entries(this.#handlers)) {
    ...
    private removeHandlersFromPanel() {
        ...
        if (this.#panel) {
            for (let [id, _] of Object.entries(this.#handlers)) {
...
export abstract class Panel extends Widget {
    ...
    protected constructor(props: PanelProps) {
        ...
        this.#panel.webview.onDidReceiveMessage(
            msg => this.handleMessage(msg), undefined, this.disposables
        );
