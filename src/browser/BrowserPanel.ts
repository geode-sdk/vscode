...
import { Badge, Element, Head, Image, Label, LoadingCircle, Spacer, Text } from '../widgets/Basic';
...
export class ItemWidget extends Widget {
	...
	becameVisible(visible: boolean) {
		...
		// eslint-disable-next-line no-cond-assign -- idk why this is here make it make sense
		if (this.#visible = visible) {
